...
public interface AlanTouringConstants {
    ...
    String ALAN_TOURING_BIOGRAPHY = "Alan Mathison Turing bio je britanski matematičar,logičar i kriptografer."+
            ...
            "zbog povrede javnog morala i osuđen na obaveznu hormonsku terapiju. Dvije godine kasnije je počinio samoubjstvo.";
    String ALAN_TOURING_QUOTE_1="Sometimes it is the people who no one imagines anything of who do the things that no one can imagine.";
    String ALAN_TOURING_QUOTE_2="Those who can imagine anything, can create the impossible.";
    String ALAN_TOURING_QUOTE_3="I believe that at the end of the century the use of words and general educated opinion will have " +
                                "altered so much that one will be able to speak of machines thinking without expecting to be contradicted.";
    String ALAN_TOURING_QUOTE_4="If a machine is expected to be infallible, it cannot also be intelligent.";
    String ALAN_TOURING_QUOTE_5="The original question, 'Can machines think?' I believe to be too meaningless to deserve discussion";
